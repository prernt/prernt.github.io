...
<script src="js/skel.min.js"></script>
	...
	<body class="homepage">
		...
		<div id="header">
                    <div id="logo">
                        <a href="#"> </a><font face="mono" size="6" color="#FFFFFF">
				...
				<nav id="nav">
					<ul>
				<li class="active"><a href="retailer_panel.jsp">Homepage</a></li>
                                                
                                                
					        <li><a href="retailer_contactus.html">Contact Us</a></li>
                                                <li><a href="retailer_uploaddata.html">Upload Data</a></li>
		
                                                <li><a href="retailer_changepassword.html">Change Password</a></li>
						<li><a href="rlogout.html">Logout</a></li>
					...
					<div id="content" class="8u skel-cell-important">
						<section>
							...
							<h3>
                                                                ...
                                                                <strong> Fed up of high drug costs?</strong>
