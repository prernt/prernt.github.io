...
<html>
    <head>
        ...
        PreparedStatement ps;
            ...
            try
            {
                ps= c.con.prepareStatement("select * from retailer_signup where ShopId='"+uname+"'");
                ResultSet rs = ps.executeQuery();
                while(rs.next())
                {
                    if(sq.equals(rs.getString(7)) && sa.equals(rs.getString(8)))
                    {
...
%>
         ...
         <font face="Arial" size="5"><font color="blue"><label id="Label1">
                                                  <%=(rs.getString(5))%></label></font></font>
                        </form>
                                                

                        <br><br><font face="Arial" size="5"><a href="index_1.html">Click here to go back.</a></font>
         ...
         <font face="Arial" size="5"><font color="blue"><label id="Label1">
                                    ...
                                    <br>
                                    <br>
                                    <font face="Arial" size="5"> <a href="index_1.html">Click here to go back.</a></font>
