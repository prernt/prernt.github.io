...
PreparedStatement ps,ps1;
        try {
                    ps= c.con.prepareStatement("select * from signuptable where Username like ?");
    ...
    if(pwd.equals(pass))
    {
    ps1= c.con.prepareStatement("update signuptable set Password=? where Username=?");
...
//ps1.executeUpdate("update signuptable set Password='"+Newpass+"'");
    ...
    <br><br><br><br><p align="center"><font size="6" face="Arial" color="white">
...
%>
<a href="user.jsp"><font size="6" face="Arial" color="white">
     <-- Go back </font></a>
